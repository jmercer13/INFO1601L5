...
function averageAssessment(students, courseName, assignment) {
    ...
    for (let i = 0; i < students.length; i++) {
        ...
        for (let j = 0; j < student.transcript.length; j++) {
            if (student.transcript[j].course === courseName) {
                let grades = student.transcript[j].grades;
                if (assignment >= 0 && assignment < grades.length) {
...
console.log("getAverageGrade(bob, 'INFO 1603'):", getAverageGrade(bob, 'INFO 1603'));
console.log("getAssignmentMark(bob, 'INFO 1603', 0):", getAssignmentMark(bob, 'INFO 1603', 0));
console.log("averageAssessment(students, 'INFO 1601', 0):", averageAssessment(students, 'INFO 1601', 0));
